 ...
 */
 ...
 @Entity 
 @Table(name = "Agencia") 
 public class Agencia_1 implements Serializable{ 
     ...
     public Agencia_1(Integer idAgencia) { 
         this.idAgencia = idAgencia; 
     } 
 
 
     public Agencia_1(Integer idAgencia, String nomAgencia) { 
         this.idAgencia = idAgencia; 
         this.nomAgencia = nomAgencia; 
     } 
 
 
     public Agencia_1(String nomAgencia) { 
         this.nomAgencia = nomAgencia; 
     } 
